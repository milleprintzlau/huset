...
<?php include("header.html"); ?>
    ...
    <article class="voluntaryListview">
       <h2 data-title2></h2>
        <p class="tekst2" data-text2></p>
       <h4>Mangler du et sted hvor du kan holde dit event, så tjek udlejningslokalerne som er tilsluttede HUSET  <a class="udlejlingsknap" href="udlejning.html">her</a></h4>
    </article>
</template>
    ...
    <script>
        ...
        async function getJSON() {
            ...
            let jsonData2 = await fetch("http://milleprintzlau.dk/huset/wordpress/wp-json/wp/v2/skab_events");
